...
public class DmpSampleMetadata {
    ...
    public String getConsentPartA() {
        if (!Strings.isNullOrEmpty(consentPartA)) {
            return (consentPartA.equalsIgnoreCase("true")
                    || consentPartA.equalsIgnoreCase("yes")) ? "YES" : "NO";
        }
        return "";
    }
    ...
    public String getConsentPartC() {
        if (!Strings.isNullOrEmpty(consentPartC)) {
            return (consentPartC.equalsIgnoreCase("true")
                    || consentPartC.equalsIgnoreCase("yes")) ? "YES" : "NO";
        }
        return "";
    }
