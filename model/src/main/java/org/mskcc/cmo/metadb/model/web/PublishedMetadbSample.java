...
public class PublishedMetadbSample {
    ...
    public PublishedMetadbSample(MetadbSample metaDbSample) throws ParseException {
        ...
        this.cmoSampleClass = latestSampleMetadata.getSampleType();
