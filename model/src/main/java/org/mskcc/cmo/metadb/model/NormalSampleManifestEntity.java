...
@NodeEntity(label = "cmo_metadb_normal_sample_metadata")
public class NormalSampleManifestEntity extends SampleManifest {
    @Id @GeneratedValue(strategy = UuidStrategy.class)
    @Convert(UuidStringConverter.class)
    private UUID uuid;
    @Relationship(type = "SP_TO_SP", direction = Relationship.INCOMING)
    private List<Sample> sampleList;
    @Relationship(type = "PX_TO_NORMAL", direction = Relationship.INCOMING)
    ...
    public NormalSampleManifestEntity() {
        super();
    }

    /**
     * NormalSampleManifestEntity constructor.
     * @param sampleManifest
     */
    public NormalSampleManifestEntity(SampleManifest sampleManifest) {
     ...
     * @param patient
     */
    public NormalSampleManifestEntity(UUID uuid, String igoId, String cmoInfoIgoId, String cmoSampleName,
